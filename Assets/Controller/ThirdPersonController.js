...
function UpdateSmoothedMovementDirection ()
{
	...
	if (grounded)
	{
		...
		// Pick speed modifier
		if (Input.GetKey (KeyCode.LeftShift) || Input.GetKey (KeyCode.RightShift) || Input.GetAxis("Run") > 0)
		{
...
function Update() {
	...
	if (inputX == 0)
	{
		inputX = Input.GetAxis("RightAnalogHorizontal") * 20;
	}

	controller.transform.Rotate(0, inputX * sensitivityX, 0);
	// ANIMATION sector
	if(_animation) {
