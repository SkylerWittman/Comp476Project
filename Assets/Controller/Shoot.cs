...
//		if (Input.GetMouseButton(0) || Input.GetAxis("Fire1") > 0)//lock for knowing when the fire button has been pressed
//        {
...
//			if (!(Input.GetMouseButton(0) || Input.GetAxis("Fire1") > 0) && (shootOnce == 0)) //Lock to verify animations
//            {
//                isAttack = false;
//                playOnce = 0;
//                if (mouseCounter > 5)
...
//                }
//            }
//			else if (Input.GetMouseButton(0) || Input.GetAxis("Fire1") > 0)//Playing the "Hold" Animation
//            {
//                anim.Play(hold.name);
//            }
